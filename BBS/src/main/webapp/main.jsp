...
<body>
	...
	<div class="maincontent">
		<div class="container">
			<div class="jumbotron">
				<div class="container">
					<h1 style="font-size: 50px">JSP 게시판 웹 사이트에 오신것을 환영합니다</h1>
					<p>This WebPage is a JSP website built with Bootstrap. </p>
					<p><a class="btn btn-primary btn-pull" href="info.jsp" role="button">자세히 알아보기</a></p>
				</div>
			</div>
		</div>
		<div class="container">
